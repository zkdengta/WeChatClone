...
class _ConversationItem extends StatelessWidget {
  ...
  _ConversationItem({Key key, this.conversation, this.tapPos}):assert(conversation != null),super(key:key);
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 2.0),
                              Text(conversation.des, style: AppStyles.DesStyle, maxLines: 1)
                            ],
                          ),
                        ),
...
class _DeviceInfoItem extends StatelessWidget {
  ...
  String get deviceName {
    return device == Device.WIN ? "Windows" : "Wac";
  }

          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                border: Border(
                  bottom: BorderSide(width: Constants.DividerWidth,color: const Color(AppColors.DividerColor))
                )
              ),
...
class _ContactsPageState extends State<ContactsPage>{
  ...
  String _getLetter(BuildContext context, double titleHeight,Offset globalPos){
  ...
  void _jumpToIndex(String letter){
    if(_letterPosMap.isNotEmpty){
      ...
      if(_pos != null){
        _scrollController.animateTo(_pos, duration: Duration(milliseconds: 200), curve: Curves.easeOut);
      }
    }
  }
    ...
    return GestureDetector(
      onVerticalDragDown: (DragDownDetails details){
        setState(() {
          ...
          widget._currentLetter = _getLetter(context,_titleHeight,details.globalPosition);
        ...
        Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.all(Radius.circular(Constants.IndexLetterBoxSize)),
            ),
            child: Center(
